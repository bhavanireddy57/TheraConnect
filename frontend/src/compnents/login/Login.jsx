      ...
      {error && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-lg shadow-xl sm:max-w-lg sm:w-full">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <button onClick={closeModal} className="w-full sm:w-auto px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                Close
              </button>
            </div>
          </div>
      ...
      <div className="w-screen mt-32">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md">
          <div className="px-6 py-4" style={{ background: 'linear-gradient(to right, #D1D5DB, #E5E7EB, #F3F4F6)' }}>
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
              Not a member? <a href="/signup" className="text-indigo-600 hover:text-indigo-500 font-semibold">Signup Now</a>
            </p>
            <p className="text-center text-sm text-gray-500">
              Go back to Homepage? <a href="/" className="text-indigo-600 hover:text-indigo-500 font-semibold">Go back</a>
            </p>
          </div>
        </div>
      </div>
