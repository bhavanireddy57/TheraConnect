...
const Home3 = () => {
  return (
    <section className="relative bg-gradient-to-b from-blue-50 via-white to-purple-50 py-24 sm:py-32">
      {/* Header */}
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Your personal companion to track mental health, write journals, chat
            anonymously, and receive personalized insights.
          </p>
        </div>

        {/* Features Grid */}
        <div className="mx-auto mt-16 max-w-4xl grid grid-cols-1 gap-10 sm:grid-cols-2 lg:gap-14">
          {features.map((feature) => (
            <div
              key={feature.name}
              className="bg-white rounded-2xl shadow-md hover:shadow-xl transition p-8 flex flex-col"
            >
              {/* Icon */}
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500 text-white shadow-md mb-6">
